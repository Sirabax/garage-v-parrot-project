 ...
 */
final class Version20231114142519 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comments ADD created DATETIME NOT NULL, DROP created_at, CHANGE comment comment LONGTEXT NOT NULL, CHANGE moderation moderation INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comments ADD created_at DATETIME DEFAULT CURRENT_TIMESTAMP, DROP created, CHANGE comment comment TEXT NOT NULL, CHANGE moderation moderation TINYINT(1) DEFAULT 0 NOT NULL');
