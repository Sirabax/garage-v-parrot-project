 ...
 */
final class Version20231106114336 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comments CHANGE comment comment TEXT NOT NULL, CHANGE moderation moderation TINYINT(1) DEFAULT 0 NOT NULL, CHANGE created_at created_at DATETIME DEFAULT CURRENT_TIMESTAMP');
